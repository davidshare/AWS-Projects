    ...
    <div class="bg-white shadow-md rounded-md p-6 mb-6">
      ...
      <form id="add-form" class="space-y-4">
        <div>
          ...
          <input type="text" id="firstname" name="firstname" class="border-gray-300 rounded-md shadow-sm w-full" required>
        </div>
        <div>
          <label for="lastname" class="block font-medium mb-1">Last Name</label>
          <input type="text" id="lastname" name="lastname" class="border-gray-300 rounded-md shadow-sm w-full" required>
        </div>
        <div>
          <label for="email" class="block font-medium mb-1">Email</label>
          <input type="email" id="email" name="email" class="border-gray-300 rounded-md shadow-sm w-full" required>
        </div>
        <div>
          <label for="phone" class="block font-medium mb-1">Phone</label>
          <input type="tel" id="phone" name="phone" class="border-gray-300 rounded-md shadow-sm w-full" required>
        </div>
        <div>
          <label for="address" class="block font-medium mb-1">Address</label>
          <input type="text" id="address" name="address" class="border-gray-300 rounded-md shadow-sm w-full" required>
        </div>
        <div>
          <label for="city" class="block font-medium mb-1">City</label>
          <input type="text" id="city" name="city" class="border-gray-300 rounded-md shadow-sm w-full" required>
        </div>
        <div>
          <label for="country" class="block font-medium mb-1">Country</label>
          <input type="text" id="country" name="country" class="border-gray-300 rounded-md shadow-sm w-full" required>
        </div>
